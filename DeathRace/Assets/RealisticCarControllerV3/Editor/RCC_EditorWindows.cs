...
public class RCC_EditorWindows : Editor {
	...
	public static void CreateRCCCamera(){
		...
		if (GameObject.FindObjectOfType<Death_Race_Camera> ()) {
			...
			Selection.activeGameObject = GameObject.FindObjectOfType<Death_Race_Camera> ().gameObject;
	...
	public static void CreateHoodCamera(){
		...
		if(!Selection.activeGameObject.GetComponentInParent<Death_Race_CarControllerV3>()){
			...
			if(Selection.activeGameObject.GetComponentInParent<Death_Race_CarControllerV3>().gameObject.GetComponentInChildren<RCC_HoodCamera>()){
			...
			GameObject hoodCam = (GameObject)Instantiate(RCC_Settings.Instance.hoodCamera, Selection.activeGameObject.GetComponentInParent<Death_Race_CarControllerV3>().transform.position, Selection.activeGameObject.GetComponentInParent<Death_Race_CarControllerV3>().transform.rotation);
			hoodCam.name = RCC_Settings.Instance.hoodCamera.name;
			hoodCam.transform.SetParent(Selection.activeGameObject.GetComponentInParent<Death_Race_CarControllerV3>().chassis.transform, true);
			hoodCam.GetComponent<ConfigurableJoint>().connectedBody = Selection.activeGameObject.GetComponentInParent<Death_Race_CarControllerV3>().gameObject.GetComponent<Rigidbody>();
	...
	public static void CreateWheelCamera(){
		...
		if(!Selection.activeGameObject.GetComponentInParent<Death_Race_CarControllerV3>()){
			...
			if(Selection.activeGameObject.GetComponentInParent<Death_Race_CarControllerV3>().gameObject.GetComponentInChildren<RCC_WheelCamera>()){
			...
			wheelCam.transform.SetParent(Selection.activeGameObject.GetComponentInParent<Death_Race_CarControllerV3>().transform, false);
	...
	public static void CreateHeadLight(){
		...
		if(!Selection.activeGameObject.GetComponentInParent<Death_Race_CarControllerV3>()){
			...
			if(!Selection.activeGameObject.GetComponentInParent<Death_Race_CarControllerV3>().transform.Find(Selection.activeGameObject.GetComponentInParent<Death_Race_CarControllerV3>().chassis.name+"/Lights")){
				lightsMain = new GameObject("Lights");
				lightsMain.transform.SetParent(Selection.activeGameObject.GetComponentInParent<Death_Race_CarControllerV3>().chassis.transform, false);
			}else{
				lightsMain = Selection.activeGameObject.GetComponentInParent<Death_Race_CarControllerV3>().transform.Find(Selection.activeGameObject.GetComponentInParent<Death_Race_CarControllerV3>().chassis.name+"/Lights").gameObject;
			}
	...
	public static void CreateExhaust(){
		...
		if(!Selection.activeGameObject.GetComponentInParent<Death_Race_CarControllerV3>()){
			...
			if(!Selection.activeGameObject.GetComponentInParent<Death_Race_CarControllerV3>().transform.Find(Selection.activeGameObject.GetComponentInParent<Death_Race_CarControllerV3>().chassis.name+"/Exhausts")){
				exhaustsMain = new GameObject("Exhausts");
				exhaustsMain.transform.SetParent(Selection.activeGameObject.GetComponentInParent<Death_Race_CarControllerV3>().chassis.transform, false);
			}else{
				exhaustsMain = Selection.activeGameObject.GetComponentInParent<Death_Race_CarControllerV3>().transform.Find(Selection.activeGameObject.GetComponentInParent<Death_Race_CarControllerV3>().chassis.name+"/Exhausts").gameObject;
			}

			GameObject exhaust = (GameObject)Instantiate(RCC_Settings.Instance.exhaustGas, Selection.activeGameObject.GetComponentInParent<Death_Race_CarControllerV3>().transform.position, Selection.activeGameObject.GetComponentInParent<Death_Race_CarControllerV3>().transform.rotation * Quaternion.Euler(0f, 180f, 0f));
	...
	static void CreateBehavior(){
		...
		if(!Selection.activeGameObject.GetComponentInParent<Death_Race_CarControllerV3>()){
			...
			CreateMirrors( Selection.activeGameObject.GetComponentInParent<Death_Race_CarControllerV3>().gameObject);
	...
	static void CreateEnterExitVehicleBehavior(){
		...
		for(int i = 0; i < selectedGameObjects.Length; i++){
			...
			if(!selectedGameObjects[i].GetComponent<RCC_EnterExitCar>() && selectedGameObjects[i].GetComponent<Death_Race_CarControllerV3>()){
				selectedGameObjects[i].AddComponent<RCC_EnterExitCar>();
			}else if(selectedGameObjects[i].GetComponent<Death_Race_CarControllerV3>()){	
	...
	static void CreateMirrors (GameObject car) {
		...
		if(!car.transform.GetComponentInChildren<RCC_Mirror>()){
			...
			mirrors.transform.SetParent(car.GetComponent<Death_Race_CarControllerV3>().chassis.transform, true);
