...
public class RCC_MobileButtons : MonoBehaviour {
	...
	public Death_Race_CarControllerV3[] carControllers;
	...
	public Death_Race_UISteeringWheelController steeringWheel;
	...
	void OnEnable(){
		...
		Death_Race_CarControllerV3.OnRCCPlayerSpawned += RCC_CarControllerV3_OnRCCSpawned;
		GetVehicles();

	}

	void RCC_CarControllerV3_OnRCCSpawned (Death_Race_CarControllerV3 RCC){
	...
	public void GetVehicles(){
		...
		carControllers = GameObject.FindObjectsOfType<Death_Race_CarControllerV3>();
	...
	public void ChangeCamera () {
		...
		if(GameObject.FindObjectOfType<Death_Race_Camera>())
			GameObject.FindObjectOfType<Death_Race_Camera>().ChangeCamera();
