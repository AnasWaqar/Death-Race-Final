...
public class RCC_CustomizerExample : MonoBehaviour {
	...
	[Header("Current Car")]
	public Death_Race_CarControllerV3 car;
	...
	void Start(){
		...
		if (!car) {
			if (GameObject.FindObjectOfType<Death_Race_Camera> () && GameObject.FindObjectOfType<Death_Race_Camera> ().playerCar)
				car = GameObject.FindObjectOfType<Death_Race_Camera> ().playerCar.GetComponent<Death_Race_CarControllerV3>();
		}
	...
	public void CheckUIs (){
		...
		case Death_Race_CarControllerV3.WheelType.FWD:
			drivetrainMode.value = 0;
			break;

		case Death_Race_CarControllerV3.WheelType.RWD:
			drivetrainMode.value = 1;
			break;

		case Death_Race_CarControllerV3.WheelType.AWD:
			drivetrainMode.value = 2;
			break;

		case Death_Race_CarControllerV3.WheelType.BIASED:
	...
	public void SetDriveTrainModeByDropdown (Dropdown dropdown){
		...
		case 0:
			RCC_Customization.SetDrivetrainMode (car, Death_Race_CarControllerV3.WheelType.FWD);
			break;

		case 1:
			RCC_Customization.SetDrivetrainMode (car, Death_Race_CarControllerV3.WheelType.RWD);
			break;

		case 2:
			RCC_Customization.SetDrivetrainMode (car, Death_Race_CarControllerV3.WheelType.AWD);
			break;
