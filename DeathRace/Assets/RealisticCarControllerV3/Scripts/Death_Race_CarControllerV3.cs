...
public class Death_Race_CarControllerV3 : MonoBehaviour {
	...
	private Death_Race_Camera carCamera;

	// EVENTS

	public delegate void onRCCPlayerSpawned(Death_Race_CarControllerV3 RCC);
	public static event onRCCPlayerSpawned OnRCCPlayerSpawned;

	public delegate void onRCCAISpawned(Death_Race_CarControllerV3 RCC);
...
//				rigid.AddRelativeTorque (Vector3.up * (((steerInput * _gasInput) * 10000f)), ForceMode.Force); 
	...
	void OnCollisionEnter (Collision collision){
		...
		if(!AIController){
			...
			if(!carCamera)
				carCamera = GameObject.FindObjectOfType<Death_Race_Camera> ();
			else
	...
	void OnDisable(){
		...
		if(canControl){
			if(gameObject.GetComponentInChildren<Death_Race_Camera>())
				gameObject.GetComponentInChildren<Death_Race_Camera>().transform.SetParent(null);
			}
