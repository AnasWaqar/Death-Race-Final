...
public class RCC_Customization : MonoBehaviour {
	...
	/// </summary>
	public static void SetCustomizationMode(Death_Race_CarControllerV3 car, bool state){
		...
		if (state) {
			...
			if (GameObject.FindObjectOfType<Death_Race_Camera> ()) {
				Death_Race_Camera cam = GameObject.FindObjectOfType<Death_Race_Camera> ();
				cam.ChangeCamera (Death_Race_Camera.CameraMode.ORBIT);
			...
			if (GameObject.FindObjectOfType<Death_Race_Camera> ()) {
				GameObject.FindObjectOfType<Death_Race_Camera> ().ChangeCamera (Death_Race_Camera.CameraMode.TPS);
				GameObject.FindObjectOfType<Death_Race_Camera> ().useOnlyWhenHold = false;
			}
	...
	/// </summary>
	public static void UpdateRCC (Death_Race_CarControllerV3 car) {
	...
	/// </summary>
	public static void SetSmokeParticle (Death_Race_CarControllerV3 car, bool state) {
	...
	/// Set Smoke Color.
	/// </summary>
	public static void SetSmokeColor (Death_Race_CarControllerV3 car, int indexOfGroundMaterial, Color color) {
	...
	/// </summary>
	public static void SetHeadlightsColor (Death_Race_CarControllerV3 car, Color color) {
	...
	/// </summary>
	public static void SetExhaustFlame (Death_Race_CarControllerV3 car, bool state) {
	...
	/// </summary>
	public static void SetFrontCambers(Death_Race_CarControllerV3 car, float camberAngle){
	...
	/// </summary>
	public static void SetRearCambers(Death_Race_CarControllerV3 car, float camberAngle){
	...
	/// </summary>
	public static void ChangeWheels(Death_Race_CarControllerV3 car, GameObject wheel){
	...
	/// </summary>
	public static void SetFrontSuspensionsTargetPos(Death_Race_CarControllerV3 car, float targetPosition){
	...
	/// </summary>
	public static void SetRearSuspensionsTargetPos(Death_Race_CarControllerV3 car, float targetPosition){
	...
	/// </summary>
	public static void SetFrontSuspensionsDistances(Death_Race_CarControllerV3 car, float distance){
	...
	/// </summary>
	public static void SetRearSuspensionsDistances(Death_Race_CarControllerV3 car, float distance){
	...
	/// Set Drivetrain Mode.
	/// </summary>
	public static void SetDrivetrainMode(Death_Race_CarControllerV3 car, Death_Race_CarControllerV3.WheelType mode){
	...
	/// </summary>
	public static void SetGearShiftingThreshold(Death_Race_CarControllerV3 car, float targetValue){
	...
	/// </summary>
	public static void SetClutchThreshold(Death_Race_CarControllerV3 car, float targetValue){
	...
	/// </summary>
	public static void SetSteeringSensitivity(Death_Race_CarControllerV3 car, bool state){
	...
	/// </summary>
	public static void SetCounterSteering(Death_Race_CarControllerV3 car, bool state){
	...
	/// 
	/// </summary>
	public static void SetNOS(Death_Race_CarControllerV3 car, bool state){
	...
	/// 
	/// </summary>
	public static void SetTurbo(Death_Race_CarControllerV3 car, bool state){
	...
	/// 
	/// </summary>
	public static void SetUseExhaustFlame(Death_Race_CarControllerV3 car, bool state){
	...
	/// 
	/// </summary>
	public static void SetRevLimiter(Death_Race_CarControllerV3 car, bool state){
	...
	/// 
	/// </summary>
	public static void SetClutchMargin(Death_Race_CarControllerV3 car, bool state){
	...
	/// </summary>
	public static void SetFrontSuspensionsSpringForce(Death_Race_CarControllerV3 car, float targetValue){
	...
	/// </summary>
	public static void SetRearSuspensionsSpringForce(Death_Race_CarControllerV3 car, float targetValue){
	...
	/// </summary>
	public static void SetFrontSuspensionsSpringDamper(Death_Race_CarControllerV3 car, float targetValue){
	...
	/// </summary>
	public static void SetRearSuspensionsSpringDamper(Death_Race_CarControllerV3 car, float targetValue){
	...
	/// </summary>
	public static void SetMaximumSpeed(Death_Race_CarControllerV3 car, float targetValue){
	...
	/// </summary>
	public static void SetMaximumTorque(Death_Race_CarControllerV3 car, float targetValue){
	...
	/// </summary>
	public static void SetMaximumBrake(Death_Race_CarControllerV3 car, float targetValue){
	...
	/// Repair Car.
	/// </summary>
	public static void RepairCar(Death_Race_CarControllerV3 car){
	...
	/// Repair Car.
	/// </summary>
	public static void SetESP(Death_Race_CarControllerV3 car, bool state){
	...
	/// Repair Car.
	/// </summary>
	public static void SetABS(Death_Race_CarControllerV3 car, bool state){
	...
	/// Repair Car.
	/// </summary>
	public static void SetTCS(Death_Race_CarControllerV3 car, bool state){
	...
	/// Repair Car.
	/// </summary>
	public static void SetSH(Death_Race_CarControllerV3 car, bool state){
	...
	/// Repair Car.
	/// </summary>
	public static void SetSHStrength(Death_Race_CarControllerV3 car, float value){
	...
	public static void SetCameraOrbitOnDrag(BaseEventData data){
		...
		if(cam.cameraMode != Death_Race_Camera.CameraMode.ORBIT)
			cam.ChangeCamera (Death_Race_Camera.CameraMode.ORBIT);
	...
	/// </summary>
	public static void SaveStats(Death_Race_CarControllerV3 car){
	...
	/// </summary>
	public static void LoadStats(Death_Race_CarControllerV3 car){
		...
		case "FWD":
			car._wheelTypeChoise = Death_Race_CarControllerV3.WheelType.FWD;
			break;

		case "RWD":
			car._wheelTypeChoise = Death_Race_CarControllerV3.WheelType.RWD;
			break;

		case "AWD":
			car._wheelTypeChoise = Death_Race_CarControllerV3.WheelType.AWD;
			break;
	...
	/// </summary>
	public static void ResetStats(Death_Race_CarControllerV3 car, Death_Race_CarControllerV3 defaultCar){
