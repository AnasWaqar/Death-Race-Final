...
public class Death_Race_ProtectCameraFromWallClip : MonoBehaviour{

	private Death_Race_Camera RCCCam;
	public float clipMoveTime = 0f;              
	...
	private void Start(){
		...
		RCCCam = GetComponent<Death_Race_Camera> ();
	...
	private void LateUpdate(){
		...
		if (RCCCam.cameraMode == Death_Race_Camera.CameraMode.FPS || RCCCam.cameraMode == Death_Race_Camera.CameraMode.WHEEL || RCCCam.cameraMode == Death_Race_Camera.CameraMode.TOP) {
